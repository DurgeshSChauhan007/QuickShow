  ...
  return nowPlayingMovies.length > 0 ? (
    <>
        ...
        <div className='overflow-x-auto pb-4 no-scrollbar'>
            <div className='group flex flex-wrap gap-4 mt-4 w-max'>
                {nowPlayingMovies.map((movie) => (
                     <div key={movie.id} className="relative max-w-40 cursor-pointer transition-all duration-300 group-hover:opacity-40 hover:opacity-100 hover:-translate-y-1" onClick={() => setSelectedMovie(movie.id)}>
        ...
        <div className='mt-8'>
            ...
            <div className='inline-flex items-center gap-2 bordr border-gray-600 px-3 py-2 rounded-md'>
        ...
        <button onClick={handleSubmit} disabled={addingShows} className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'>Add Show</button>
    </>
  ) : <Loading />
}
