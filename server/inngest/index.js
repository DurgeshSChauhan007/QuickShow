...
const releaseSeatsAndDeleteBooking = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('check-payment-status', async () => {
            ...
            // If payment is not made, release seats and deleted booking
            if (!booking.isPaid) {
    ...
    const results = await step.run('send-all-reminders', async ()=> {
        return await Promise.allSettled(
            reminderTasks.map(task => sendEmail({
                ...
                body: `<div style="fonr-family: Arial, sans-serif; padding: 20px;">
                    ...
                    <br />
                    <p>Enjoy the show! <br /> -- Durgesh QuickShow Team </p>
                </div>`
            }))
        )
    })
...
const sendNewShowNotifications = inngest.createFunction(
    { id: "send-new_show-notifications"},
    ...
    async ({ event }) => {
        ...
        for (const user of users) {
            ...
            const body = `<div style='font-family: Arial, sans-serif; padding: 20px;'>
                ...
                <br />
                <p>Thanks, <br /> -- Durgesh QuickShow Team</p>
            </div>`;
